...
import com.spaService.ServiceBookingSystem.services.company.CompanyService;
...
public class CompanyController {
    ...
    public ResponseEntity<?> postAd(@PathVariable Long userId, @ModelAttribute AdDTO adDTO) throws Exception {
...
//    in tutorial companyService not getAllReservations by getAllAdBookings
    public ResponseEntity<List<ReservationDTO>> getAllReservations(@PathVariable Long companyId){
        return ResponseEntity.ok(companyService.getAllReservations(companyId));
    }
